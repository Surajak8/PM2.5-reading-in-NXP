...
void BOARD_BootClockPLL150M(void)
{
    ...
    // Add this right after other clock setups
    CLOCK_SetClkDiv(kCLOCK_DivFlexcom2Clk, 1U);  // Set LPUART2 clock divider
    CLOCK_AttachClk(kMAIN_CLK_to_FLEXCOMM2);     // Attach main clock to LPUART2
